...
# Pretend that someone has already done the specific parsing, and has left you with variables that contain the following information for a news story:
...
#   Your task, in this problem, is to write a class, NewsStory, starting with a constructor that takes (guid, title, subject, summary, link) as arguments
...
class NotTrigger(Trigger):
    ...
    def evaluate(self, story):
        return not self.trigger.evaluate(self)
...
class AndTrigger(Trigger):
    def __init__(self, t1, t2):
        ...
        self.t2 = t2
    def evaluate(self, story):
        return self.t1.evaluate(self) and self.t2.evaluate(self)
...
class OrTrigger(Trigger):
    def __init__(self, t1, t2):
        ...
        self.t2 = t2
    def evaluate(self, story):
        return self.t1.evaluate(self) or self.t2.evaluate(self)
